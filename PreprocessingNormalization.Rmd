...
dend %>% set("leaves_pch", 19) %>%  # node point type
  ...
  plot()
```
![SNP Dendrogram](https://github.com/lmcewen/CRELES/tree/master/GitFigs/CRELES_preprocessing_SNPs.png)
...
```
![MDS Plot](https://github.com/lmcewen/CRELES/tree/master/GitFigs/CRELES_preprocessingMDS.png)
...
![Incorrectly Labelled Sample](https://github.com/lmcewen/CRELES/tree/master/GitFigs/CRELES_preprocessing_mislabelledSample.png)
...
```
![Correctly Labelled Sample](https://github.com/lmcewen/CRELES/tree/master/GitFigs/CRELES_preprocessing_correctlyLabelled.png)
...
![raw beta distribution](https://github.com/lmcewen/CRELES/tree/master/GitFigs/CRELES_preprocessing_rawbeta_dist.png)
...
![raw m-value distribution](https://github.com/lmcewen/CRELES/tree/master/GitFigs/CRELES_preprocessing_rawmvas_dist.png)
...
```
![PCA heat scree plot before SWAN](https://github.com/lmcewen/CRELES/tree/master/GitFigs/CRELES_normalization_heatscreeprenorm.png)
...
heat_scree_plot(Loadings, Importance)
```
![PCA heat scree plot after SWAN](https://github.com/lmcewen/CRELES/tree/master/GitFigs/CRELES_normalization_heatscree_afterSWAN.png)
...
heat_scree_plot(Loadings, Importance)
```
![PCA heat scree plot after SWAN and combat for sentrix ID](https://github.com/lmcewen/CRELES/tree/master/GitFigs/CRELES_normalization_heatscree_afterswanbat.png)
...
```
![PCA heat scree plot after SWAN and combat for both sentrix ID and row](https://github.com/lmcewen/CRELES/tree/master/GitFigs/CRELES_normalization_heatscree_afterswanbat2.png)
...
heat_scree_plot(Loadings, Importance)
```
![PCA heat scree plot after SWAN and combat for both sentrix ID and row but include estimated cell types](https://github.com/lmcewen/CRELES/tree/master/GitFigs/CRELES_normalization_heatscree_afterswanbat2_withcelltypes.png)
...
heat_scree_plot(Loadings, Importance)
```
![PCA heat scree plot after SWAN and combat for both sentrix ID and row but include estimated cell types](https://github.com/lmcewen/CRELES/tree/master/GitFigs/CRELES_normalization_heatscree_afterswanbat2decon.png)
